    ...
    <section className="landing-hero">
      <div className="landing-hero__copy">
        ...
        <div className="landing-hero__benefits" aria-label="Beneficios de Yommigo">
          <div><span><Truck /></span><p><strong>Entrega r&aacute;pida</strong><small>en minutos</small></p></div>
          <div><span><ShieldCheck /></span><p><strong>Pago seguro</strong><small>y protegido</small></p></div>
          <div><span><BadgeCheck /></span><p><strong>Restaurantes</strong><small>verificados</small></p></div>
        </div>
      </div>
      <div className="landing-hero__visual" aria-label="Hamburguesa artesanal con queso y vegetales">
        ...
        <div className="landing-hero__local-card"><span><Heart /></span><p><strong>Apoya lo local</strong><small>M&aacute;s de 1,200 restaurantes<br />en tu ciudad</small></p></div>
      </div>
    </section>
  );
}
